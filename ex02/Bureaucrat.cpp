...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/30 13:44:16 by bince             #+#    #+#             */
/*   Updated: 2024/12/30 13:44:18 by bince            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(std::string formName, int gradeExecute)
{
    if(this->getGrade() <= gradeExecute)
    {
        std::cout<<"Bureaucrat succesfully executed Form -" << formName << "-." << std::endl;
    }
    else
        throw Bureaucrat::GradeTooLowToExecuteException();
}
...
{
    return("Bureaucrat's grade is low to execute this Form");
}
